...
class State:
    ...
    def is_goal(self):
        """returns True if the called State object is the goal state
        and False otherwise
        """
    ...
    def generate_successors(self):
        ...
        successor states of the called State objects for all
        successor states of the called State objectt.
        """
        successors = []
        for m in MOVES:
            b = self.board.copy()
        ...
        return successors
                    #fix this, the moves aren't the right integer
